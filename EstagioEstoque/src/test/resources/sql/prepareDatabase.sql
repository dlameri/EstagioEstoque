...
ALTER TABLE IMAGENS ALTER COLUMN CD_IMAGEM RESTART WITH 1;
ALTER TABLE ITEM ALTER COLUMN CD_ITEM RESTART WITH 1;
ALTER TABLE PRODUTO ALTER COLUMN CD_PRODUTO RESTART WITH 1;
ALTER TABLE ADMINISTRADOR ALTER COLUMN CD_ADMINISTRADOR RESTART WITH 1;
ALTER TABLE SUBCATEGORIA ALTER COLUMN CD_SUBCATEGORIA RESTART WITH 1;
ALTER TABLE CATEGORIA ALTER COLUMN CD_CATEGORIA RESTART WITH 1;
ALTER TABLE DIMENSOES ALTER COLUMN CD_DIMENSOES RESTART WITH 1;
